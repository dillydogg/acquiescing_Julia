...
# ╔═╡ 6ff55412-9512-11ec-1a64-15200ec2a965
using DataFrames

# ╔═╡ abf3ffe6-dd51-4af2-b29a-05e4174f3a8b
using Statistics

# ╔═╡ cdf7d112-6735-4dd1-b2dd-959f80f97388
using GLM

# ╔═╡ 34cd8c83-18b8-4325-a88f-73adf53665cc
using CairoMakie

# ╔═╡ e178b650-c17a-4c5f-be69-6fa418f70dd3
using PlutoUI

# ╔═╡ e533ac88-5bea-4a46-b879-3507efaa3cf6
...
# ╔═╡ f6b6f245-13d5-4742-a7f2-cae209c8ead6
df = DataFrame(aq, :auto)

# ╔═╡ c64b71f9-2e81-4d73-9136-bfbf0cfc6e4a
new_names = vec(string.(["x", "y"], [1 2 3 4]))

# ╔═╡ d3578642-196f-43cd-909b-2d3741a6a10d
rename!(df, new_names)

# ╔═╡ 8a331dab-22da-4452-956e-be9172fd160a
df.y1

# ╔═╡ ae5e8ad7-ced1-4f92-959f-2499d5642be2
df[:, :y1]

# ╔═╡ 3995e119-f410-4017-9da6-99dcd09b2063
select!(df, r"x", :)

# ╔═╡ e1f34a85-0e24-4682-9432-a9137f08f6f5
describe(df, mean => :mean, std => :std)

# ╔═╡ 19a69cd5-c3d8-46f2-95c6-4e815a16fa84
stack(df)

# ╔═╡ 2b971a77-3d2f-4391-9d5d-dc7728b369b2
(select(df, r"x") |> Matrix |> extrema) .+(-1, 1) |> collect

# ╔═╡ 14a4e00f-f92a-4d18-97ac-89cf14af5aa9
(select(df, r"y") |> Matrix |> extrema) .+(-1, 1) |> collect

# ╔═╡ 1dc11d1d-b2e8-4e54-b817-d59702f6464d
with_terminal() do
	for reg in [r"x", r"y"]
		println((select(df, reg) |> Matrix |> extrema) .+(-1, 1) |> collect)
	end
end
